    ...
    <div className="min-h-screen bg-white text-[#1A1A1A] font-sans overflow-x-hidden">
            ...
            <div key={i} className="flex flex-col items-center text-center rounded-[8px] border border-gray-200 bg-white shadow-sm p-3 h-full">
              ...
              {box.cta && (
                <div className="mt-auto w-full">
                  ...
                  {/* <p className="text-[7px] text-red-600 mt-1 font-bold">(sign up page)</p> */}
                </div>
              )}
            </div>
          ))}
      ...
      <section className="px-3 py-10 bg-gray-50">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-[#EBF3EF] rounded-[16px] border border-primary/10 shadow-xl p-4">
            ...
            <Link href="/auth/signup" className="block w-full bg-[#1B4323] text-white text-[12px] font-black py-3 rounded-[8px] text-center hover:bg-[#112a16] transition-colors shadow-lg">
              Get help now
            </Link>
      ...
      <section className="py-12 px-5 text-center">
        ...
        <div className="bg-[#1B4323] rounded-2xl p-8 shadow-xl">
          ...
          <Link href="/clients" className="inline-block bg-white text-[#1B4323] px-10 py-3 rounded-full font-black text-lg shadow-lg hover:bg-gray-100 transition-all">
            Learn more
          </Link>
          <div className="mt-4">
            {/* <p className="text-[10px] text-white/60 font-bold uppercase tracking-widest">(Clients page)</p> */}
          </div>
        </div>
      </section>
